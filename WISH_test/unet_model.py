...
class Unet(nn.Module):
    def __init__(self):
        ...
        self.layer1_conv = double_conv2d_bn(1, 16)
        self.layer2_conv = double_conv2d_bn(16, 32)
        self.layer3_conv = double_conv2d_bn(32, 64)
        self.layer4_conv = double_conv2d_bn(64, 128)
        ...
        self.layer10_conv = nn.Conv2d(16, 1, kernel_size=3, padding=1)
    ...
    def forward(self, x):
        ...
        pool1 = F.avg_pool2d(conv1, 2)

        conv2 = self.layer2_conv(pool1)
        pool2 = F.avg_pool2d(conv2, 2)

        conv3 = self.layer3_conv(pool2)
        pool3 = F.avg_pool2d(conv3, 2)

        conv4 = self.layer4_conv(pool3)
        pool4 = F.avg_pool2d(conv4, 2)
